...
await goto(`${baseUrl}/centro/${centreId}/dias-no-lectivos`);
await page.screenshot({ path: `${imgRoot}/centro/centro-dias-no-lectivos.png` });
console.log('OK centro-dias-no-lectivos.png');
