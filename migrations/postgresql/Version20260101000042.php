...
final class Version20260101000042 extends AbstractMigration
{
    ...
    {
        return 'Añade el ajuste de prefijo del asunto de los correos de notificación (PostgreSQL)';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            INSERT INTO setting_definition (id, key, type, default_value, global_scope, centre_scope, teacher_scope, min_value, max_value, category, category_order, position) VALUES
                (gen_random_uuid(), 'notifications.email_subject_prefix', 'string', '', TRUE, TRUE, FALSE, NULL, 50, 'settings.category.email_alerts', 50, 140)
        SQL);
    }
