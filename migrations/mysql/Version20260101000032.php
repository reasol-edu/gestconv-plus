...
final class Version20260101000032 extends AbstractMigration
{
    ...
    {
        return 'Añade el ajuste de duración de la pantalla "Hoy" del modo tablón y ajusta las duraciones por defecto de semana actual y siguiente (MySQL / MariaDB)';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            INSERT INTO setting_definition (id, `key`, type, default_value, global_scope, centre_scope, teacher_scope, min_value, max_value, category, category_order, position) VALUES
                (UNHEX(REPLACE(UUID(), '-', '')), 'board.today_seconds', 'integer', '60', 1, 1, 0, 0, 3600, 'settings.category.board', 30, 5)
        SQL);
