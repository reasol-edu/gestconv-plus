...
final class Version20260101000017 extends AbstractMigration
{
    ...
    {
        return 'Ajuste de días de aviso de prescripción próxima de partes (MySQL / MariaDB)';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            INSERT INTO setting_definition (id, `key`, type, default_value, global_scope, centre_scope, teacher_scope, min_value, max_value, category, category_order, position) VALUES
                (UNHEX(REPLACE(UUID(), '-', '')), 'notifications.report_prescription_warning_days', 'integer', '7', 1, 1, 1, 0, 365, 'settings.category.notifications', 40, 40)
        SQL);
    }
