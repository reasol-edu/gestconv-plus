...
final class Version20260101000014 extends AbstractMigration
{
    ...
    {
        return 'Añade category, category_order y position a setting_definition, y agrupa los ajustes existentes (SQLite)';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE setting_definition ADD COLUMN category_order INTEGER NOT NULL DEFAULT 0');
        $this->addSql('ALTER TABLE setting_definition ADD COLUMN position INTEGER NOT NULL DEFAULT 0');
