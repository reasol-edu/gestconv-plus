...
final class Version20260101000015 extends AbstractMigration
{
    ...
    {
        return 'Ajuste de tema del modo tablón: claro, oscuro o según el sistema (SQLite)';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql("INSERT INTO setting_definition (id, key, type, default_value, global_scope, centre_scope, teacher_scope, min_value, max_value, choices, category, category_order, position) VALUES
            ('00000000-0000-4000-8000-000000000010', 'board.theme', 'choice', 'light', 1, 1, 0, NULL, NULL, 'light,dark,system', 'settings.category.board', 30, 30)
        ");
    }
